...
/**
 * Review comments moderation grid.
 */
class Index extends Action implements HttpGetActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $resultPage->setActiveMenu('ETechFlow_AdvancedProductReviews::comments');
        $resultPage->getConfig()->getTitle()->prepend(__('Review Comments'));
        return $resultPage;
    }
}
