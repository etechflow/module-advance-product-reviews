...
/**
 * License validation for ETechFlow_AdvancedProductReviews.
 *
...
class LicenseValidator
{
    ...
    public const XML_PATH_LICENSE_KEY            = 'etechflow_reviews/license/license_key';
    public const XML_PATH_ISSUED_KEY             = 'etechflow_reviews/license/issued_key';
    public const XML_PATH_ISSUED_AT              = 'etechflow_reviews/license/issued_at';
    public const XML_PATH_IP_BLOCKED             = 'etechflow_reviews/license/ip_blocked';
    public const XML_PATH_PORTAL_URL             = 'etechflow_reviews/license/portal_url';
    public const XML_PATH_PRODUCTION_ENVIRONMENT = 'etechflow_reviews/license/production_environment';
    ...
    // ── cache ───────────────────────────────────────────────────────────────
    private const CACHE_TAG    = 'ETECHFLOW_APR';
    private const CACHE_PREFIX = 'etf_apr_lic_';
    ...
    {
        // phpcs:ignore Magento2.Security.InsecureFunction.FoundWithAlternative -- non-security cache-key hash only
